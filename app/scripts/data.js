var data = [
	{
		name: 'Starry Night',
		bio: 'Vinnie painted this one. Cool.',
		date: 'June 1889',
...

	{
		...
		bio: 'The Church at Auvers plays a prominent role in "Vincent and the Doctor", the tenth episode of the fifth series of the revived science-fiction television programme Doctor Who in 2010. In it, the painting depicts a strange, griffin-esque creature at a window of the church, which signifies to the show\'s time-travelling protagonist, the Doctor, that something evil was lurking in Auvers-sur-Oise in June 1890.',
		date: 'June, 1890',
		avatar: 'http://timeoffun.com/pics/Vincent-van-Gogh/Vincent-van-Gogh-3.JPG',
		source: '<a href="http://en.wikipedia.org/wiki/The_Church_at_Auvers">Wikipedia</a>'
	},

	{
		name: 'Van Gogh\'s Chair',
		bio: 'In 1888 Vincent van Gogh painted Van Gogh\'s Chair as one of two unusual portraits depicting himself and his friend Paul Gauguin. For his own portrait, van Gogh used one of the twelve simple chairs he had purchased when he furnished the Yellow House. His pipe and a pouch of tobacco on the rush seat and the box of onions that bears his name serve as rustic attributes that contrast to the more elegant items he chose to represent Paul Gauguin. The predominant hue in Van Gogh\'s Chair is yellow, which van Gogh now regarded as his signature color.',
		date: 'December, 1888',
		avatar: 'http://www.vggallery.com/painting/f_0498.jpg',
		source: '<a href src=\'http://entertainment.howstuffworks.com/arts/artwork/vincent-van-gogh-paintings-from-the-yellow-house3.htm>\'HowStuffWorks.com</a>'
	},

	{
		name: 'Portrait of Milliet, Second Lieutenant of the Zouaves',
		bio: 'This painting depicts Paul-Eugène Milliet, second lieutenant in the third regiment of the Zouaves. Milliet and Vincent van Gogh became friends in 1888 when both men were in Arles, France',
		date: 'September, 1888',
		avatar: 'http://www.vggallery.com/painting/f_0473.jpg',
		source: '<a href src="http://www.vggallery.com/painting/p_0473.htm">Vggallery.com</a>'
	}
